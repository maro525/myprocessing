...
public class sketch_180722 extends PApplet {
...
{
    int _n = PApplet.parseInt(random(8,10));
...
public void draw() {
    ...
    for(int iy = 0; iy < GRID_NUM; iy++)
    {
        for(int ix = 0; ix < GRID_NUM; ix++){
            ...
            int draw_ind = PApplet.parseInt(frameCount / split_num);
            if(index < draw_ind) drawBSpline(ix, iy, 1.0f);
            if(index == draw_ind ) {
...
class BSplineCurve {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_180722" };
    if (passedArgs != null) {
